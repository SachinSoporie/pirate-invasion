...
function preload() {
  ...
  explsoion = loadSound("assets/cannon_explosion.mp3");
  water_sound = loadSound("assets/cannon_water.mp3");
  pirater_laugh = loadSound("assets/pirate_laugh.mp3");
}
